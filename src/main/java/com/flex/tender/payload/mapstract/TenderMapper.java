...
public interface TenderMapper {
    ...
    BidderTenderSummaryResponse toBidderTenderSummary(Tender tender, ETenderStatus status);

    ContractorTenderSummaryResponse toContractorTenderSummary(Tender tender, Integer offers);
