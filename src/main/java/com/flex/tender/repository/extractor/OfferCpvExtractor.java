...
public class OfferCpvExtractor implements ResultSetExtractor<Map<Integer, Cpv>> {
    ...
    public Map<Integer, Cpv> extractData(ResultSet resultSet) throws SQLException, DataAccessException {
        ...
        while (resultSet.next()) {
            result.put(resultSet.getObject("offer_id", Integer.class), cpvMapper.mapCpv(resultSet));
        }
        return result;
    }
