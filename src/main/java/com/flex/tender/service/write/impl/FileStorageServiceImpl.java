...
public class FileStorageServiceImpl implements FileStorageService {
    ...
    public FileMetadataResponse upload(MultipartFile file) throws IOException {
        ...
        return fileMapper.toResponse(fileRepository.save(FileMetadata.builder().name(originalFilename)
                .contentType(file.getContentType()).awsS3fileKey(fileKey.toString()).build()));
    }
